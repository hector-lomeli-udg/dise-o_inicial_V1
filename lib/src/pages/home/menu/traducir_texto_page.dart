    ...
    return SafeArea(
      child: Container(
        ...
        child: Column(
            ...
            children: [
              Text('Haga click en el cuadro de texto para teclear su texto deseado y usar los botones para traducir o guardar traduccion', style:TextStyle( color: Colors.white, fontSize: 20.0, fontWeight: FontWeight.bold),),
