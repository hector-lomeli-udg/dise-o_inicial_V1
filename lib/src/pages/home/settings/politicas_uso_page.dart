    ...
    return SafeArea(
      child: Container(
        ...
        child: Column(
            ...
            children: [
              Text('Politicas de uso de Traduciendo con sentido', style:TextStyle( color: Colors.white, fontSize: 30.0, fontWeight: FontWeight.bold),),
